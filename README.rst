...
.. image:: http://img.shields.io/badge/docs-v1.6.3-yellow.svg
   :target: https://www.idiap.ch/software/bob/docs/bob/gridtk/v1.6.3/index.html
.. image:: http://img.shields.io/badge/docs-latest-orange.svg
   :target: https://www.idiap.ch/software/bob/docs/bob/gridtk/master/index.html
.. image:: https://gitlab.idiap.ch/bob/gridtk/badges/v1.6.3/build.svg
   :target: https://gitlab.idiap.ch/bob/gridtk/commits/v1.6.3
.. image:: https://gitlab.idiap.ch/bob/gridtk/badges/v1.6.3/coverage.svg
   :target: https://gitlab.idiap.ch/bob/gridtk/commits/v1.6.3

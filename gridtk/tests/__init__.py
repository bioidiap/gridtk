...
class GridTKTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.jman = which(
            "jman", path=os.pathsep.join((bindir, os.environ["PATH"]))
        )
    ...
    def notest02_grid(self):
        ...
        raise nose.plugins.skip.SkipTest(
            "This test is not yet implemented. If you find a proper ways to test the grid functionality, please go ahead and implement the test."
        )
